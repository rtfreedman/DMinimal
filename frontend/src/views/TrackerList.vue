  ...
  <v-container>
    ...
    <v-dialog v-model="showAddCharacterDialog">
      ...
      <app-add-character-dialog
        ...
        @addCharacter="addNewCharacter($event)"
      />
    </v-dialog>
...
export default {
  ...
  methods: {
    ...
    addNewCharacter(name) {
      // TBD: validate
      // TBD: have the DM input a bare minimum amount of data
      //      so that the app doesn't need to deal with
      //      null state for important properties
