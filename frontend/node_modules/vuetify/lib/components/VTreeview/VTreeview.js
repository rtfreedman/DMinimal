...
/* @vue/component */
    ...
    watch: {
        ...
        active: function active(v) {
            ...
            if (deepEqual([].concat(_toConsumableArray(this.activeCache)), v)) return;
        ...
        value: function value(v) {
            ...
            if (!v || deepEqual([].concat(_toConsumableArray(this.selectedCache)), v)) return;
        ...
        open: function open(v) {
            ...
            if (deepEqual([].concat(_toConsumableArray(this.openCache)), v)) return;
