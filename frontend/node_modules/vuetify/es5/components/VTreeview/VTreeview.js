...
/* @vue/component */
    ...
    watch: {
        ...
        active: function active(v) {
            ...
            if ((0, _helpers.deepEqual)([].concat(_toConsumableArray(this.activeCache)), v)) return;
        ...
        value: function value(v) {
            ...
            if (!v || (0, _helpers.deepEqual)([].concat(_toConsumableArray(this.selectedCache)), v)) return;
        ...
        open: function open(v) {
            ...
            if ((0, _helpers.deepEqual)([].concat(_toConsumableArray(this.openCache)), v)) return;
    ...
    methods: {
        ...
        emitSelected: function emitSelected() {
            this.$emit('change', [].concat(_toConsumableArray(this.selectedCache)));
        },
